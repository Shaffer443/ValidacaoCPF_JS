...
function validaCPF(cpf){
  if(cpf.length != 11){
    ...
    var numeros = cpf.substring(0,9); //verifica os 9 priemiros
      var digitos = cpf.substring(9); //verifica os dois ultimos
...
function validacao(){
  ...
  var cpf = document.getElementById('numeros').value;
  //console.log(cpf);
